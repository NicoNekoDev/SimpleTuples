...
import io.github.NicoNekoDev.SimpleTuples.func.OctetConsumer;
import io.github.NicoNekoDev.SimpleTuples.func.OctetFunction;
...
public class Octet<T1, T2, T3, T4, T5, T6, T7, T8> extends OctetImpl<T1, T2, T3, T4, T5, T6, T7, T8> implements Serializable {
    ...
    public final <R> R apply(OctetFunction<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? extends R> func) {
        return func.apply(super.value1, super.value2, super.value3, super.value4, super.value5, super.value6, super.value7, super.value8);
    }

    public final void accept(OctetConsumer<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8> cons) {
        cons.accept(super.value1, super.value2, super.value3, super.value4, super.value5, super.value6, super.value7, super.value8);
    }
