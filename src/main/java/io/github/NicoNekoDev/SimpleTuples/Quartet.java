...
import io.github.NicoNekoDev.SimpleTuples.func.QuartetConsumer;
...
public class Quartet<T1, T2, T3, T4> extends QuartetImpl<T1, T2, T3, T4> implements Serializable {
    ...
    public final <R> R apply(QuartetFunction<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> func) {
        return func.apply(super.value1, super.value2, super.value3, super.value4);
    }

    public final void accept(QuartetConsumer<? super T1, ? super T2, ? super T3, ? super T4> cons) {
        cons.accept(super.value1, super.value2, super.value3, super.value4);
    }
