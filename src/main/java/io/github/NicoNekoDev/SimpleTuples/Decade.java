...
import io.github.NicoNekoDev.SimpleTuples.func.DecadeConsumer;
import io.github.NicoNekoDev.SimpleTuples.func.DecadeFunction;
...
public class Decade<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> extends DecadeImpl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> implements Serializable {
    ...
    public final <R> R apply(DecadeFunction<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? super T10, ? extends R> func) {
        return func.apply(super.value1, super.value2, super.value3, super.value4, super.value5, super.value6, super.value7, super.value8, super.value9, super.value10);
    }

    public final void accept(DecadeConsumer<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? super T10> cons) {
        cons.accept(super.value1, super.value2, super.value3, super.value4, super.value5, super.value6, super.value7, super.value8, super.value9, super.value10);
    }
